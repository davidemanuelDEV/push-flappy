/**
 * Country helpers for daily board (ISO 3166-1 alpha-2 + flag).
 */
...
/** Regional indicator symbols for a 2-letter ISO code → flag emoji. */
...
/**
 * Best-effort country from edge / proxy headers.
 * Prefer Vercel / Cloudflare IP country; fall back to Accept-Language region.
 */
